...
public class RegistroTransacoesBancarias {
    ...
    public static void main(String[] args) {
        ...
        // Usando um final para iterar no loop For. Nesses casos, um array permite que o programa circunde o
        // problema de não poder iterar em constantes.
        final int[] contador = {1};
        
        System.out.println("Saldo: " + saldo);
        System.out.println("Transacoes:");
        transacoes.stream().forEach(n -> {System.out.println(contador[0] + ". " + n);
                                         contador[0]++;});
